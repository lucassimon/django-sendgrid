...
"""
Starter fabfile for deploying the send_grid project.
...
if not hasattr(env, 'prod'):
    ...
    env.hosts = ['@']
    env.project_name = u'send_grid'
    env.shell = u'/bin/zsh -c'
    env.code_dir = u'~/sites/send_grid'
    env.git_repo = u'git@github.com:lucassimon/git'
    env.settings = u'--settings=send_grid.settings.production'
